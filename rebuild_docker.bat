...
echo [INFO] Rebuilding and starting MSMS with Docker...
...
if errorlevel 1 (
  echo [ERROR] Docker containers could not be rebuilt and started.
...
echo.
echo [DONE] MSMS was rebuilt and started with Docker.
echo [TIP] Use start_docker.bat for normal daily startup.
