# G:/msms/backend/msms_project/settings/base.py
import os
...
ROOT_URLCONF = 'msms_project.urls'
...
WSGI_APPLICATION = 'msms_project.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='msms_db'),
        'USER': config('DB_USER', default='msms_user'),
        'PASSWORD': config('DB_PASSWORD', default='msms_pass'),
